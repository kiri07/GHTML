var UCRenderer =
            {
                ...
                {   var maxlength=uses.length>actors.length? uses.length : actors.length;
                    ...
                    var res="<canvas class='gigio' width='1500' height='"+maxlength*240+"' style='border:1px solid #d3d3d3;'></canvas>";
                    ...
                    for (var i = 1; i <= maxlength; i ++)
                    {
                        ...
                        res+="<div class='ucrel'></div><div></div><canvas class='gigi' style='width:100%;'></canvas>";
                        res+="</div><div class='"+(((i%b)==0 &&(Math.floor(i/b)<=uses.length))?("ucfield'>"+uses[Math.floor(i/b)-1]):"emptycol'>");
                    
                        res += "</div></div>";
                    }
                    res+="<div class='ucRow'><div class='emptycol'></div></div>";
                     res+="<div class='ucRow'><div class='emptycol'></div></div>";
                    return res;
                }
            }
